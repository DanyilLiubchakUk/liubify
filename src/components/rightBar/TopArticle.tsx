...
export function TopArticle({ scroll,thirdCollapce }: TopArticleProps) {
    ...
    return (
        <div className={`flex justify-between items-center gap-4 p-4 my-2 sticky top-0 left-0 bg-neutral-900 shadow-black ${scroll > 7.5 ? "shadow-md" : ""}`}>
            ...
            <div className="flex items-center gap-3">
                ...
                <button className="hover:fill-stone-100 transition-colors" onClick={thirdCollapce}>
